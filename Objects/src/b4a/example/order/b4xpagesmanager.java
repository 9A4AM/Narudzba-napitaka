...
public class b4xpagesmanager extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.order.b4xpagesmanager");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.order.b4xpagesmanager.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public b4a.example.order.b4xorderedmap _idtob4xpage = null;
public b4a.example.order.b4xorderedmap _rootb4xtopage = null;
public anywheresoftware.b4j.object.JavaObject _context = null;
public b4a.example.order.b4xset _mstackofpageids = null;
...
public b4a.example.order.b4xmainpage _mainpage = null;
public String _stackstring = "";
public boolean _logevents = false;
public b4a.example.order.main _main = null;
...
public b4a.example.order.b4xpagesmanager._b4xpageparent Parent;
public void Initialize() {
IsInitialized = true;
B4XPage = new Object();
Id = "";
...
IsFirst = false;
Parent = new b4a.example.order.b4xpagesmanager._b4xpageparent();
}
@Override
		public String toString() {
			return BA.TypeToString(this, false);
...
b4a.example.order.b4xpagesmanager._b4xpageinfo _pi = null;
...
public b4a.example.order.b4xpagesmanager._b4amenuitem  _addmenuitem(Object _b4xpage,Object _title) throws Exception{
b4a.example.order.b4xpagesmanager._b4amenuitem _mi = null;
...
_mi = new b4a.example.order.b4xpagesmanager._b4amenuitem();
...
_findpifromb4xpage(_b4xpage).Parent /*b4a.example.order.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_mi));
...
_pi = (b4a.example.order.b4xpagesmanager._b4xpageinfo)(group5.Get(index5));
...
_idtob4xpage = new b4a.example.order.b4xorderedmap();
 //BA.debugLineNum = 24;BA.debugLine="Private RootB4XToPage As B4XOrderedMap";
_rootb4xtopage = new b4a.example.order.b4xorderedmap();
...
_mstackofpageids = new b4a.example.order.b4xset();
...
_mainpage = new b4a.example.order.b4xmainpage();
...
public String  _closepageimpl(b4a.example.order.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public boolean  _closerequestexists(b4a.example.order.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public b4a.example.order.b4xpagesmanager._b4xpageinfo  _createb4xpageinfo(Object _b4xpage,String _id,boolean _created,Object _title) throws Exception{
b4a.example.order.b4xpagesmanager._b4xpageinfo _t1 = null;
...
_t1 = new b4a.example.order.b4xpagesmanager._b4xpageinfo();
...
public b4a.example.order.b4xpagesmanager._b4xpageparent  _createb4xpageparent(Object _nativetype) throws Exception{
b4a.example.order.b4xpagesmanager._b4xpageparent _t1 = null;
...
_t1 = new b4a.example.order.b4xpagesmanager._b4xpageparent();
...
{
final anywheresoftware.b4a.BA.IterableList group4 = _pi.Parent /*b4a.example.order.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ ;
final int groupLen4 = group4.getSize()
;int index4 = 0;
;
for (; index4 < groupLen4;index4++){
_mi = (b4a.example.order.b4xpagesmanager._b4amenuitem)(group4.Get(index4));
...
public String  _createpageifneeded(b4a.example.order.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public String  _createpageimpl(b4a.example.order.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Parent /*b4a.example.order.b4xpagesmanager._b4xpageparent*/  = _createb4xpageparent((Object)(_mmainform.getObject()));
 //BA.debugLineNum = 384;BA.debugLine="pi.Parent.MenuItems.Initialize";
_pi.Parent /*b4a.example.order.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
 //BA.debugLineNum = 392;BA.debugLine="End Sub";
return "";
}
public b4a.example.order.b4xpagesmanager._b4xpageinfo  _findpifromb4xpage(Object _page) throws Exception{
b4a.example.order.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (b4a.example.order.b4xpagesmanager._b4xpageinfo)(group1.Get(index1));
...
if (true) return (b4a.example.order.b4xpagesmanager._b4xpageinfo)(__c.Null);
...
public b4a.example.order.b4xpagesmanager._b4xpageinfo  _getpagefromid(String _id) throws Exception{
b4a.example.order.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (b4a.example.order.b4xpagesmanager._b4xpageinfo)(_idtob4xpage._get /*Object*/ ((Object)(_id.toLowerCase())));
...
public b4a.example.order.b4xpagesmanager._b4xpageinfo  _getpageinfofromroot(anywheresoftware.b4a.objects.B4XViewWrapper _root) throws Exception{
...
if (true) return (b4a.example.order.b4xpagesmanager._b4xpageinfo)(_rootb4xtopage._get /*Object*/ ((Object)(_root.getObject())));
 //BA.debugLineNum = 409;BA.debugLine="End Sub";
return null;
}
public b4a.example.order.b4xpagesmanager._b4xpageinfo  _gettoppage() throws Exception{
...
if (true) return (b4a.example.order.b4xpagesmanager._b4xpageinfo)(_idtob4xpage._get /*Object*/ (_mstackofpageids._aslist /*anywheresoftware.b4a.objects.collections.List*/ ().Get((int) (_mstackofpageids._getsize /*int*/ ()-1))));
 //BA.debugLineNum = 595;BA.debugLine="End Sub";
return null;
}
public void  _handlecloserequest(b4a.example.order.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
ResumableSub_HandleCloseRequest rsub = new ResumableSub_HandleCloseRequest(this,_pi);
rsub.resume(ba, null);
}
public static class ResumableSub_HandleCloseRequest extends BA.ResumableSub {
public ResumableSub_HandleCloseRequest(b4a.example.order.b4xpagesmanager parent,b4a.example.order.b4xpagesmanager._b4xpageinfo _pi) {
this.parent = parent;
this._pi = _pi;
}
b4a.example.order.b4xpagesmanager parent;
b4a.example.order.b4xpagesmanager._b4xpageinfo _pi;
...
public String  _logevent(b4a.example.order.b4xpagesmanager._b4xpageinfo _pi,String _ev) throws Exception{
String _msg = "";
...
public String  _raiseevent(b4a.example.order.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
public Object  _raiseeventwithresult(b4a.example.order.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
_pi.Parent /*b4a.example.order.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ .setTitle(BA.ObjectToCharSequence(_title));
 //BA.debugLineNum = 367;BA.debugLine="End Sub";
return "";
}
public String  _showpage(String _id) throws Exception{
b4a.example.order.b4xpagesmanager._b4xpageinfo _pi = null;
b4a.example.order.b4xpagesmanager._b4xpageinfo _top = null;
...
b4a.example.order.b4xpagesmanager._b4xpageinfo _pi = null;
b4a.example.order.b4xpagesmanager._b4xpageinfo _pagetoremove = null;
...
public String  _showpageimpl(b4a.example.order.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Parent /*b4a.example.order.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ .setTitle(BA.ObjectToCharSequence(_pi.Title /*Object*/ ));
