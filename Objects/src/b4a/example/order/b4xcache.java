...
public class b4xcache extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.order.b4xcache");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.order.b4xcache.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public b4a.example.order.b4xorderedmap _data = null;
...
_data = new b4a.example.order.b4xorderedmap();
...
public b4a.example.order.b4xcache._b4xcacheitem  _createb4xcacheitem(Object _value,String _key) throws Exception{
b4a.example.order.b4xcache._b4xcacheitem _t1 = null;
...
_t1 = new b4a.example.order.b4xcache._b4xcacheitem();
...
b4a.example.order.b4xcache._b4xcacheitem _ci = null;
...
_ci = (b4a.example.order.b4xcache._b4xcacheitem)(_data._get /*Object*/ ((Object)(_key)));
...
_ci = (b4a.example.order.b4xcache._b4xcacheitem)(group3.Get(index3));
...
_data._remove /*String*/ ((Object)(((b4a.example.order.b4xcache._b4xcacheitem)(_values.Get(_i))).Key /*String*/ ));
 }
};
 };
