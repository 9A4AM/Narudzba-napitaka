...
public class b4xpagesdelegator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.order.b4xpagesdelegator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.order.b4xpagesdelegator.class).invoke(this, new Object[] {null});
        else
...
_b4xpages._getmanager /*b4a.example.order.b4xpagesmanager*/ (getActivityBA())._activity_actionbarhomeclick /*String*/ ();
...
if (true) return _b4xpages._getmanager /*b4a.example.order.b4xpagesmanager*/ (getActivityBA())._activity_keypress /*boolean*/ (_keycode);
...
_b4xpages._getmanager /*b4a.example.order.b4xpagesmanager*/ (getActivityBA())._activity_pause /*String*/ ();
...
_b4xpages._getmanager /*b4a.example.order.b4xpagesmanager*/ (getActivityBA())._raiseevent /*String*/ (_b4xpages._getmanager /*b4a.example.order.b4xpagesmanager*/ (getActivityBA())._gettoppage /*b4a.example.order.b4xpagesmanager._b4xpageinfo*/ (),"B4XPage_PermissionResult",new Object[]{(Object)(_permission),(Object)(_result)});
...
_b4xpages._getmanager /*b4a.example.order.b4xpagesmanager*/ (getActivityBA())._activity_resume /*String*/ ();
...
_b4xpages._getmanager /*b4a.example.order.b4xpagesmanager*/ (getActivityBA())._createmenu /*String*/ (_menu);
...
_b4xpages._getmanager /*b4a.example.order.b4xpagesmanager*/ (getActivityBA())._mainform_resize /*String*/ (_width,_height);
