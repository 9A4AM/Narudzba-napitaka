...
public static b4a.example.order.b4xpagesdelegator _delegate = null;
...
public static b4a.example.order.b4xpagesmanager._b4amenuitem  _addmenuitem(anywheresoftware.b4a.BA _ba,Object _b4xpage,Object _title) throws Exception{
...
if (true) return _getmanager(_ba)._addmenuitem /*b4a.example.order.b4xpagesmanager._b4amenuitem*/ (_b4xpage,_title);
...
public static b4a.example.order.b4xpagesmanager  _getmanager(anywheresoftware.b4a.BA _ba) throws Exception{
 //BA.debugLineNum = 14;BA.debugLine="Public Sub GetManager As B4XPagesManager";
 //BA.debugLineNum = 15;BA.debugLine="Return mPM";
if (true) return (b4a.example.order.b4xpagesmanager)(_mpm);
...
if (true) return _getmanager(_ba)._findpifromb4xpage /*b4a.example.order.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Parent /*b4a.example.order.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ ;
...
if (true) return _getmanager(_ba)._findpifromb4xpage /*b4a.example.order.b4xpagesmanager._b4xpageinfo*/ (_b4xpage).Id /*String*/ ;
...
if (true) return _mpm instanceof b4a.example.order.b4xpagesmanager;
 //BA.debugLineNum = 11;BA.debugLine="End Sub";
return false;
}
public static b4a.example.order.b4xmainpage  _mainpage(anywheresoftware.b4a.BA _ba) throws Exception{
...
if (true) return _getmanager(_ba)._mainpage /*b4a.example.order.b4xmainpage*/ ;
...
_delegate = new b4a.example.order.b4xpagesdelegator();
