...
public class b4xbytesbuilder extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.example.order.b4xbytesbuilder");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.example.order.b4xbytesbuilder.class).invoke(this, new Object[] {null});
        else
...
public b4a.example.order.b4xbytesbuilder  _append(byte[] _data) throws Exception{
...
public b4a.example.order.b4xbytesbuilder  _append2(byte[] _data,int _startindex,int _length) throws Exception{
int _oldlength = 0;
...
if (true) return (b4a.example.order.b4xbytesbuilder)(this);
