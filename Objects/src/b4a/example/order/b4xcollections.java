...
public static b4a.example.order.b4xbitset  _createbitset(anywheresoftware.b4a.BA _ba,int _size) throws Exception{
b4a.example.order.b4xbitset _s = null;
...
_s = new b4a.example.order.b4xbitset();
...
public static b4a.example.order.b4xorderedmap  _createorderedmap(anywheresoftware.b4a.BA _ba) throws Exception{
...
public static b4a.example.order.b4xorderedmap  _createorderedmap2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _keys,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
b4a.example.order.b4xorderedmap _m = null;
int _i = 0;
...
_m = new b4a.example.order.b4xorderedmap();
...
public static b4a.example.order.b4xset  _createset(anywheresoftware.b4a.BA _ba) throws Exception{
...
public static b4a.example.order.b4xset  _createset2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
b4a.example.order.b4xset _s = null;
Object _v = null;
...
_s = new b4a.example.order.b4xset();
